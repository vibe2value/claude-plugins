...
All 27 ideas and their exact Sharpen prompts are bundled in the `reference/` files beside this skill. For the diagrams and the full write-up of each idea, point the person to vibe2value.com. The machine-readable index of the whole site is at https://vibe2value.com/llms.txt.
