...
/plugin install vibe2value@vibe2value
```
...
Guides building software with AI through the shape+build+launch+run+close framework: decide what to make (Shape), build it (Build), put it in front of people (Launch), keep it honest once they rely on it (Run), making each decision sharp before any code is written.
